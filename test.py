...
if __name__ == '__main__':
    ...
    parser.add_argument('--video', type=str, default=r'.\datasets\test_data\mix\%04d.jpg')
    args = parser.parse_args()

    tmp=os.path.dirname( args.video)
    files_num=len(os.listdir(tmp))
    testlabel=tmp.split('\\')[-1]
    print(testlabel)
    num=0
